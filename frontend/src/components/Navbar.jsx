...
const Navbar = () => {
    ...
    return (
        <div className="flex justify-between p-4 pb-8 top-0 sticky border-b-2">
            <div className="lg:hidden pt-6 size-5 pl-3">
                <button>
                    <svg
            ...
            <div className="flex gap-7 pr-2 md:pr-10 pt-6">
                <input
                    type="text"
                    placeholder="Search..."
